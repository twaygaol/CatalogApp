...
import brownisImage from '../images/brownis.jpg'; // Misalnya saja untuk kategori "brownis"
import almondImage from '../images/kue1.jpg'; // Misalnya saja untuk kategori "Almond"
import drinkImage from '../images/snack/1.png';
import snackImage from '../images/snack2/6.png';
import minicake from '../images/minicake/1.png';
import BigCake from '../images/bigcake/1.png';
import tierImage from '../images/cake/kuma.png';
...
export default function Recipes() {
  ...
  const categoryImages = {
    Brownis: brownisImage,
    MiniCake: almondImage,
    Drink:drinkImage,
    Snack:snackImage,
    MiniCake:minicake,
    TierCake:BigCake,
  ...
  return (
    <View style={{ marginHorizontal: wp(4) }}>
          ...
          {categories.map((category, index) => (
            <Pressable
              ...
              style={{
                ...
                paddingVertical: 5,
                backgroundColor: activeCategory === category ? '#6B46C1' : '#D1D5DB',
                borderRadius: 8,
              }}
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',marginTop:10 }}>
        <Text style={{ fontSize: hp(2.5), fontWeight: '600', color: '#4B5563', marginBottom: hp(2) }}>Latters Menu</Text>
        <Text style={{ fontSize: hp(2),opacity:1, fontWeight: '500', color: '#1B3C73', position: 'absolute', right: 20, top: 0 }}>View All</Text>
      </View>
      <View>
